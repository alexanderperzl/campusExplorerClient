...
class PinView @JvmOverloads constructor(context: Context, attr: AttributeSet? = null) :
    ...
    private var pinUebung = BitmapUtil.createCrispBitmap(R.drawable.pin_uebung2, resources)
    private var pinSeminar = BitmapUtil.createCrispBitmap(R.drawable.pin_seminar, resources)
    private var pinOther = BitmapUtil.createCrispBitmap(R.drawable.pin_other2, resources)
